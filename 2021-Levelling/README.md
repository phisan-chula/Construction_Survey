...
เมื่อใช้ซอฟต์แวร์ DiffLev อ่านข้อมูลนำเข้าเข้าไปแล้ว โปรแกรมจะทำการคำนวนและวิเคราะห์ข้อมูล ให้สังเกตุ ช้อมูลทึ่มี ดอกจันทน์ * ต่อท้าย ข้อมูนั้นอาจผิดพลาด หรือ มีค่าเกณฑ์ที่กำหนด   ให้ทำการแก้ใชอินพุท YAML ใหม แล้วทำการวิเคราะห์ตรวจสอบซ้ำ
DiffLev ยังมีการวาดกราฟฟิกช่วยให้ทราบถึงผลการส่องอ่านไม้ระดับแต่ละการตั้งกล้องดังนี้  
